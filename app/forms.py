...
class SurveyForm(FlaskForm):
    ...
    question7 = StringField("How do you envision the progression of your career?", widget=TextArea(),render_kw={'class': 'form-control', 'rows': 10, 'style': 'width: 1000px'}, validators=[DataRequired()])
